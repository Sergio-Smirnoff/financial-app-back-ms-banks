...
public class CheckingAccount extends Account {
    ...
    public CheckingAccount(String cbu, String alias, Money balance, UserId userId,
    ...
    public Account withBalance(Money newBalance, LocalDateTime updatedAt) {
        return new CheckingAccount(cbu, alias, newBalance, userId, bankName, name, isActive, createdAt, updatedAt);
    }
}
