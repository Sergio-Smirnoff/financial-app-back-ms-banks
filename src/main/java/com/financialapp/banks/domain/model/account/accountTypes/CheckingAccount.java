...
public class CheckingAccount extends Account {
    ...
    public CheckingAccount(Cbu cbu, String alias, Money balance, UserId userId,
    ...
    public Account withBalance(Money newBalance, LocalDateTime updatedAt) {
        return new CheckingAccount(cbu, alias, newBalance, userId, bankNumber, name, isActive, createdAt, updatedAt);
    }
}
