...
public class InvestmentAccount extends Account {
    ...
    public InvestmentAccount(Cbu cbu, String alias, Money balance, UserId userId,
    ...
    public Account withBalance(Money newBalance, LocalDateTime updatedAt) {
        return new InvestmentAccount(cbu, alias, newBalance, userId, bankNumber, name, isActive, createdAt, updatedAt);
    }

    @Override
    protected void ensureNotInvestmentRestricted() {
        throw new AccountInvestmentRestrictionException(cbu.value());
    }
}
