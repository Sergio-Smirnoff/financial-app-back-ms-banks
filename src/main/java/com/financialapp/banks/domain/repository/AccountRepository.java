...
public interface AccountRepository {
    ...
    boolean existsByBankNumberAndName(BankNumber bankNumber, String name);
    boolean existsByBankNumberAndTypeAndCurrency(BankNumber bankNumber, String type, Currency currency);
