...
class CardAggregatePersistenceIT {
    ...
    void save_then_load_round_trips_installments() {
        ...
        Card card = Card.create("5555555555554444", new UserId(1L), new BankNumber("007"), details,
        ...
        Card reloaded = cardRepository.findByCardNumber("5555555555554444").orElseThrow();
