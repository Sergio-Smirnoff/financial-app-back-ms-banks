...
class UpcomingPaymentTest {
    ...
    void exposesFieldsAndValueSemantics() {
        ...
        var a = new UpcomingPayment(1L, "LOAN", "Loan 1", amount, LocalDate.of(2026, 7, 1), 2, 12, false);
        var b = new UpcomingPayment(1L, "LOAN", "Loan 1", amount, LocalDate.of(2026, 7, 1), 2, 12, false);
        var c = new UpcomingPayment(2L, "CARD", "Card 1", amount, LocalDate.of(2026, 7, 1), 1, 6, true);
